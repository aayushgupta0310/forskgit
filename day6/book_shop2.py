# -*- coding: utf-8 -*-
"""
Created on Mon May 13 12:46:40 2019
...
list1 = [ [1, ("5464", 4, 9.99), ("8274",18,12.99), ("9744", 9, 44.95)], 
      ...
      [3, ("5464", 9, 9.99), ("88112", 11, 24.99)],
      [4, ("8732", 7, 11.99), ("7733",11,18.99), ("88112", 5, 39.95)] ]
order_list = [item[0] for item in list1]
cost = [item[1][1]*item[1][2]+item[2][1]*item[2][2]+item[3][1]*item[3][2] if len(item)>=4 else item[1][1]*item[1][2]+item[2][1]*item[2][2] for item in list1]
final = list(zip(order_list,cost))
print(final)