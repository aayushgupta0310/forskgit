# -*- coding: utf-8 -*-
"""
Created on Sat May 11 12:03:51 2019
...
import re
with open("simpsons_phone_book.txt",'rt') as phone_book:
    for item in phone_book.readlines():
        if re.findall(r'[j.J]{1}\w*\s+Neu',item):
            print(item)